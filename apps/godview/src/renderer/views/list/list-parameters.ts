...
export const LIST_PARAMETER_GROUPS: readonly MonitorParameterGroup[] = [
  {
    ...
    controls: [
      ...
      { key: 'projectWidth', label: 'Project column', min: 90, max: 280, step: 5, defaultValue: 150 },
    ],
  },
];
...
export function normalizeListParameters(value: unknown): ListParameters {
  const source = value && typeof value === 'object' ? (value as Partial<Record<keyof ListParameters, unknown>>) : {};

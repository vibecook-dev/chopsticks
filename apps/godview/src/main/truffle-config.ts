...
export interface GodviewTruffleConfig {
  enabled: boolean;
...
export function godviewTruffleConfig(options: GodviewTruffleConfigOptions): GodviewTruffleConfig {
  ...
  return {
    ...
    environment: {
      ...
      GHOSTTEA_TRUFFLE_DEVICE_NAME:
        ...
        `${options.hostname ?? hostname()} · Godview`,
